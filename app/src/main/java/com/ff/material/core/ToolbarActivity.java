...
import com.ff.material.core.adapter.EndlessRecyclerOnScrollListener;
import com.ff.material.core.adapter.LoadMoreAdapter;
        ...
        loadMoreAdapter.setOnItemClickListener(new LoadMoreAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                ActivityOptionsCompat optionsCompat = ActivityOptionsCompat.makeSceneTransitionAnimation(
                        ...
                        view.findViewById(R.id.iv_icon),// 共享元素的控件
                        "basic");// 需要和activity_movie_detail的iv_movie_icon的transitionName名称一致，表示共享元素
