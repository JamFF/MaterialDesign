package com.ff.material.behavior;
...
public class BehaviorFragment extends Fragment {
    ...
    private static class OnScrollListener extends RecyclerView.OnScrollListener {
        ...
        private WeakReference<BehaviorFragment> mReference;

        private int mSuspensionHeight;// 顶部悬浮条的高度
        private int mCurrentPosition;// 当前RecyclerView第一个展示的position

        private OnScrollListener(BehaviorFragment fragment) {
        ...
        public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
            ...
            BehaviorFragment fragment = mReference.get();
